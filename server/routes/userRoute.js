...
router.route("/update-skill/:skillID").put(protect,restrictTo("admin"),PostSkill)
...
router.route("/delete-skill/:skillID").delete(protect,restrictTo("admin"),PostSkill)
